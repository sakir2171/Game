...
def Level_Easy(Actual_Number):
    """Code for Easy Level"""       #This is Docstrings (A Python docstring is a string used to document a Python module, class, function or method, so programmers can understand what it does without having to read the details of the implementation)
                                    #For more info about Docstrings (Link: https://www.youtube.com/watch?v=xTmBq-CQTVU&list=PLu0W_9lII9agICnT8t4iYVSZ3eykIAOME&index=24)
    No_Guess = 1
    while (True):
...
def Level_Medium(Actual_Number):
    """Code for Medium Level"""         #This is Docstrings (A Python docstring is a string used to document a Python module, class, function or method, so programmers can understand what it does without having to read the details of the implementation)
                                    #For more info about Docstrings (Link: https://www.youtube.com/watch?v=xTmBq-CQTVU&list=PLu0W_9lII9agICnT8t4iYVSZ3eykIAOME&index=24)
    No_Guess = 1
    while (True):
        Player_Guess = int(input("Enter your Guess Number: "))
...
def Level_Hard(Actual_Number):
    """Code for Hard Level"""           #This is Docstrings (A Python docstring is a string used to document a Python module, class, function or method, so programmers can understand what it does without having to read the details of the implementation)
                                    #For more info about Docstrings (Link: https://www.youtube.com/watch?v=xTmBq-CQTVU&list=PLu0W_9lII9agICnT8t4iYVSZ3eykIAOME&index=24)
    No_Guess = 1
    while (True):
        Player_Guess = int(input("Enter your Guess Number: "))
...
if choose.capitalize() == "Easy":
    Level_Easy(Actual_Number)

#Medium Level Code
elif choose.capitalize() == "Medium":
    Level_Medium(Actual_Number)


#Hard Level Code
elif choose.capitalize() == "Hard":
    Level_Hard(Actual_Number)
